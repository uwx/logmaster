...
public final class HLogger {
    ...
    public static void grey(final int level, final Object message) {
        write(level, System.currentTimeMillis(), true, message == null ? "null" : message.toString(), Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final int level, final Exception exception) {
        write(level, System.currentTimeMillis(), true, ThrowableUtils.getStackTrace(exception), Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final Object message) {
        write(Level.INFO, System.currentTimeMillis(), true, message == null ? "null" : message.toString(), Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final Exception exception) {
        write(Level.SEVERE, System.currentTimeMillis(), true, ThrowableUtils.getStackTrace(exception), Chalk.grey_open, Chalk.grey_close);
    }
    
    // 2-arg methods
    public static void grey(final int level, final Object msg1, Object msg2, final long timeStamp, final boolean logToFile) {
        write(level, timeStamp, logToFile, msg1 + " " + msg2, Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final int level, final Object msg1, Object msg2) {
        write(level, System.currentTimeMillis(), true, msg1 + " " + msg2, Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final Object msg1, Object msg2) {
        write(Level.INFO, System.currentTimeMillis(), true, msg1 + " " + msg2, Chalk.grey_open, Chalk.grey_close);
    }
    
    // vararg methods
    public static void grey(final int level, final Object[] msgs, final long timeStamp, final boolean logToFile) {
        write(level, timeStamp, logToFile, Arrays.toString(msgs), Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final int level, final Object... msgs) {
        write(level, System.currentTimeMillis(), true, Arrays.toString(msgs), Chalk.grey_open, Chalk.grey_close);
    }

    public static void grey(final Object... msgs) {
        write(Level.INFO, System.currentTimeMillis(), true, Arrays.toString(msgs), Chalk.grey_open, Chalk.grey_close);
    }
    ...
    public static void brightGray(final int level, final Object message) {
        write(level, System.currentTimeMillis(), true, message == null ? "null" : message.toString(), Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final int level, final Exception exception) {
        write(level, System.currentTimeMillis(), true, ThrowableUtils.getStackTrace(exception), Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final Object message) {
        write(Level.INFO, System.currentTimeMillis(), true, message == null ? "null" : message.toString(), Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final Exception exception) {
        write(Level.SEVERE, System.currentTimeMillis(), true, ThrowableUtils.getStackTrace(exception), Chalk.brightGray_open, Chalk.brightGray_close);
    }
    
    // 2-arg methods
    public static void brightGray(final int level, final Object msg1, Object msg2, final long timeStamp, final boolean logToFile) {
        write(level, timeStamp, logToFile, msg1 + " " + msg2, Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final int level, final Object msg1, Object msg2) {
        write(level, System.currentTimeMillis(), true, msg1 + " " + msg2, Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final Object msg1, Object msg2) {
        write(Level.INFO, System.currentTimeMillis(), true, msg1 + " " + msg2, Chalk.brightGray_open, Chalk.brightGray_close);
    }
    
    // vararg methods
    public static void brightGray(final int level, final Object[] msgs, final long timeStamp, final boolean logToFile) {
        write(level, timeStamp, logToFile, Arrays.toString(msgs), Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final int level, final Object... msgs) {
        write(level, System.currentTimeMillis(), true, Arrays.toString(msgs), Chalk.brightGray_open, Chalk.brightGray_close);
    }

    public static void brightGray(final Object... msgs) {
        write(Level.INFO, System.currentTimeMillis(), true, Arrays.toString(msgs), Chalk.brightGray_open, Chalk.brightGray_close);
    }
    ...
    public static final class Chalk {
        ...
        public static transient final String brightBlack_open = "\u001b[30;1m";
        public static transient final String brightBlack_close = "\u001b[0m";

        public static transient final String brightRed_open = "\u001b[31;1m";
        public static transient final String brightRed_close = "\u001b[0m";

        public static transient final String brightGreen_open = "\u001b[32;1m";
        public static transient final String brightGreen_close = "\u001b[0m";

        public static transient final String brightYellow_open = "\u001b[33;1m";
        public static transient final String brightYellow_close = "\u001b[0m";

        public static transient final String brightBlue_open = "\u001b[34;1m";
        public static transient final String brightBlue_close = "\u001b[0m";

        public static transient final String brightMagenta_open = "\u001b[35;1m";
        public static transient final String brightMagenta_close = "\u001b[0m";

        public static transient final String brightCyan_open = "\u001b[36;1m";
        public static transient final String brightCyan_close = "\u001b[0m";

        public static transient final String brightWhite_open = "\u001b[37;1m";
        public static transient final String brightWhite_close = "\u001b[0m";

        public static transient final String brightGray_open = "\u001b[90;1m";
        public static transient final String brightGray_close = "\u001b[0m";
        ...
        public static void p_brightGray(final String s) {
            HLogger.log(brightGray_open + s + brightGray_close);
        }
        ...
        public static String brightGray(final String s) {
            return brightGray_open + s + brightGray_close;
        }
